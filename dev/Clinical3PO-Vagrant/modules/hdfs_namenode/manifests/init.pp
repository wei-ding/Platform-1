...
class hdfs_namenode {
  ...
  file { "/tmp/concept.txt":
    ...
    source => dos2unix("files/concept.txt"),
    owner => c3po,
    group => hadoop,
  }
  ->
  ...
  file { "/tmp/person-merged.txt":
    ...
    source => dos2unix("files/person-merged.txt"),
    owner => c3po,
    group => hadoop,
  }
  ->
  ...
  file { "/tmp/death-merged.txt":
    ...
    source => dos2unix("files/death-merged.txt"),
    owner => c3po,
    group => hadoop,
  }
  ->
  ...
  file { "/tmp/observation-merged.txt":
    ...
    source => dos2unix("files/observation-merged.txt"),
    owner => c3po,
    group => hadoop,
  }
  ->
